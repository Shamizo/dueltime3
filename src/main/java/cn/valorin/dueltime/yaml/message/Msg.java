...
public enum Msg {
    ...
    ARENA_TYPE_CLASSIC_RECONNECT_AUTO_LEAVE_ARENA("Arena.type.classic.reconnect-auto-leave-arena", "&e检测到您重新连接服务器，由于您仍在竞技场中，现已自动将您移出竞技场"),
    ARENA_TYPE_CLASSIC_RECONNECT_AUTO_LEAVE_SPECTATE("Arena.type.classic.reconnect-auto-leave-spectate", "&e检测到您重新连接服务器，由于您仍在观战中，现已自动将您移出观战"),
    ARENA_TYPE_CLASSIC_RECONNECT_AUTO_LEAVE_QUEUE("Arena.type.classic.reconnect-auto-leave-queue", "&e检测到您重新连接服务器，由于您仍在等待队列中，现已自动将您移出等待队列"),
    ARENA_STATE_MONITOR_AUTO_TELEPORT("Arena.state-monitor.auto-teleport", "&c检测到您在已完成的竞技场中，现已将您传送离开"),
    ARENA_STATE_MONITOR_KILL_ILLEGAL_STAY("Arena.state-monitor.kill-illegal-stay", "&c您在竞技场中非法逗留，已被处死"),
    ;
